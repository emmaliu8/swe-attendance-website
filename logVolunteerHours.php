<?php /* Template Name: logVolunteerHours.php */ ?>
	...
	<div class="container">
		<div class="row two-columns">
            <div class="main-column col-md-9">
                ...
                $getAllEventsQuery = "SELECT Name FROM Events WHERE EventType = 'Outreach' OR EventType = 'Recruiting' ORDER BY Name";
                ...
                <form action="/swe/logEventAction.php">
                    ...
                    <input id="volunteerHours" name="volunteerHours" type="number" step="0.1" min="0" required/>
                    <br>
                    <br>
